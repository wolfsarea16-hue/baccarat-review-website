...
const TermsAndConditions = () => {
    const terms = [
        ...
        "A balance of less than $50 is not allowed to start reviewing, members should ensure that they have a balance of $50 before starting reviewing.",
        ...
        "Members need to complete 30 reviews to be eligible for withdrawal.",
        ...
        "If a member fails to complete reviewing of all products in the account on time and does not provide a reasonable explanation or notify the Customer Support in time, the platform reserves the right to take necessary measures, including temporary account freezing, demanding a security deposit, or taking legal action to pursue personal negligence responsibility.",
        "If you need to turn off membership upgrade privileges, you must go to Customer Support and request that this privilege be turned off before you begin reviewing.",
